 ...
 * @property {object} brand - The container of the bot's brand information.
 * @property {string} brand.name - The bot's brand name.
 * @property {number} brand.colour - The bot's brand hex colour.
 * @property {string} brand.logoUrl - The bot's brand logo url.
 */
